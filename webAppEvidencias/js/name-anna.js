...
function startGame(){
  ...
  //set music
  mySound = new sound("../media/audio/sound.mp3");
...
function change(){
  ...
  if (image_tracker == 'white'){
    image.src = '../media/img/byellow2.png';
    image_tracker = 'yellow';
  }

  else{
    image.src = '../media/img/bwhite.png';
    image_tracker = 'white';
  }
}
...
function jump(){
  ...
  let timerUp = setInterval(function(){
    //SALTAR
    if (woman.getAttribute("src") == "../media/img/abuela-right-mario.png" && right == true){
      woman.setAttribute("src", "../media/img/abuela-salto.png");
    }
    else if(woman.getAttribute("src") == "../media/img/abuela-left-mario.png" && left == true){
      woman.setAttribute("src", "../media/img/abuela-salto-left.png");
    }
    else if (woman.getAttribute("src") == "../media/img/abuela-right-mario.png"){
      woman.setAttribute("src", "../media/img/abuela-salto.png");
    }
    if(character.y < floor - 200){
      ...
      let timerDown = setInterval(function(){
        //BAJAR
        if (woman.getAttribute("src") == "../media/img/abuela-salto.png" && right == true){
          woman.setAttribute("src", "../media/img/abuela-right-mario.png");
        }
        else if(woman.getAttribute("src") == "../media/img/abuela-salto-left.png" && left == true){
          woman.setAttribute("src", "../media/img/abuela-left-mario.png");
        }
        else if (woman.getAttribute("src") == "../media/img/abuela-salto.png"){
          woman.setAttribute("src", "../media/img/abuela-right-mario.png");
        }
...
function control(e) {    
  ...
  if(e.keyCode == 37 && character.x > 0){
    ...
    if (woman.getAttribute("src") == "../media/img/abuela-right-mario.png"){
      woman.setAttribute("src", "../media/img/abuela-left-mario.png");
    }        
  ...
  if(e.keyCode == 39 && character.x < 830){
    //ir hacia la derecha
    if (woman.getAttribute("src") == "../media/img/abuela-left-mario.png"){
      woman.setAttribute("src", "../media/img/abuela-right-mario.png");
    }
